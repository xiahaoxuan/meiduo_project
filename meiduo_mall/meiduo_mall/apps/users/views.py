...
class UserBrowserHistory(LoginRequiredJsonMixin, View):
    def post(self, request):
        ...
        try:
            ...
            return http.HttpResponseForbidden('sku_id参数错误')
        # 保持数据到Redis
...
class UpdateDeleteAddressView(View):
    ...
    def delete(self, request, address_id):
        try:
            ...
            logger.error(e)
            return http.JsonResponse({'code': RETCODE.DBERR, 'errmsg': '删除地址成功'})
...
class AddressView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        context = {
            'default_address_id': login_user.default_address_id or 'None',
